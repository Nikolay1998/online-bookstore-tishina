...
insert into book values(4, 'Герой нашего времени', 2, 'Описание', 5);
insert into book values(5, 'Мцыри', 2, 'Описание', 5);
insert into book values(6, 'Бородино', 2, 'Описание', 5);
insert into book values(7, 'Смерть поэта', 2, 'Описание', 5);
insert into book values(8, 'Демон', 2, 'Описание', 5);
